    ...
    return (
        <BitnationWrapper>
            <Container className="h-[10vh] my-5 lg:h-[30vh] lg:my-10 "
                ...
                <motion.div className="flex flex-col  justify-center lg:h-[20vh]"
                initial={{
                    opacity: 0,
                    x: -100
                }}
                ...
                >
                    <h1 className="text-white text-2xl font-bold uppercase lg:text-4xl">Contactos</h1>
                </motion.div>
            </Container>
            <Container >
                    <HelpInfo onSubmit={() => { }} />
            </Container>
            <Container className="h-[50vh] my-5 lg:h-[60vh] lg:my-10"
                style={{
                    backgroundImage: `url(/image18.png)`,
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                }}>
            ...
            <Container className="pb-10">
                <Grid columns={{ xl: 2, lg: 2, md: 1, sm: 1 }}>
                    <motion.div className="text-black space-y-4"
                    initial={{
                        opacity: 0,
                        x: -100
                    }}
                    ...
                    >
                        ...
                        <ul className="text-lg list-disc pl-5 text-blue-500 hover:underline hover:cursor-pointer">
                            <li>Calle Federico Henríquez y Carvajal #37, Sector Tamboril, Santiago de los Caballeros, Rep. Dom.</li>
                        </ul>
                    </motion.div>
                    ...
                    >
                        <div className="mapContainer w-full">
                            ...
                            <button className="bg-black text-white px-4 py-4 w-fit font-bold mt-4 justify-center items-center block sm:hidden" onClick={() => { }}>
